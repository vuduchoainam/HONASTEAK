...
!function (e, t) {
        ...
        w.extend = w.fn.extend = function () {
            ...
            for ("boolean" == typeof o && (c = o,
                ...
                if (null != (e = arguments[a]))
                    for (t in e)
                        n = e[t],
                            "__proto__" !== t && o !== n && (c && n && (w.isPlainObject(n) || (s = Array.isArray(n))) ? (i = o[t],
                                r = s && !Array.isArray(i) ? [] : s || w.isPlainObject(i) ? i : {},
                                s = !1,
                                o[t] = w.extend(c, r, n)) : void 0 !== n && (o[t] = n));
            return o
        }
        ,
        w.extend({
            ...
            makeArray: function (e, t) {
                var i = t || [];
                return null != e && (x(Object(e)) ? w.merge(i, "string" == typeof e ? [e] : e) : o.call(i, e)),
                    i
            },
    ...
    var C = function (e) {
        var t, i, n, s, r, o, a, l, c, u, h, d, p, f, g, m, v, y, $, b = "sizzle" + 1 * new Date, w = e.document, x = 0, C = 0, _ = ec(), T = ec(), E = ec(), k = ec(), A = function (e, t) {
            return e === t && (h = !0),
                0
        }, S = {}.hasOwnProperty, D = [], L = D.pop, N = D.push, O = D.push, P = D.slice, I = function (e, t) {
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, j = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + z + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", M = "\\[" + z + "*(" + H + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + z + "*\\]", q = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", W = RegExp(z + "+", "g"), B = RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$", "g"), F = RegExp("^" + z + "*," + z + "*"), R = RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"), V = RegExp(z + "|>"), X = RegExp(q), U = RegExp("^" + H + "$"), K = {
            ID: RegExp("^#(" + H + ")"),
            CLASS: RegExp("^\\.(" + H + ")"),
            TAG: RegExp("^(" + H + "|[*])"),
            ATTR: RegExp("^" + M),
        ...
        }, Q = /HTML$/i, Y = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, G = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, et = RegExp("\\\\[\\da-fA-F]{1,6}" + z + "?|\\\\([^\\r\\n\\f])", "g"), ei = function (e, t) {
            var i = "0x" + e.slice(1) - 65536;
            return t || (i < 0 ? String.fromCharCode(i + 65536) : String.fromCharCode(i >> 10 | 55296, 1023 & i | 56320))
        }, en = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, es = function (e, t) {
        ...
        function el(e, t, n, s) {
            var r, a, c, u, h, f, v, y = t && t.ownerDocument, w = t ? t.nodeType : 9;
            if (n = n || [],
            ...
            if (!s && (d(t),
                    ...
                    if (r = h[1]) {
                        if (9 === w) {
                            ...
                            if (c.id === r)
                                return n.push(c),
                                    n
                        } else if (y && (c = y.getElementById(r)) && $(t, c) && c.id === r)
                            return n.push(c),
                                n
                    } else {
                        if (h[2])
                ...
                if (i.qsa && !k[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e,
                        ...
                        for ((y = ee.test(e) && ey(t.parentNode) || t) === t && i.scope || ((u = t.getAttribute("id")) ? u = u.replace(en, es) : t.setAttribute("id", u = b)),
                            a = (f = o(e)).length; a--;)
                            f[a] = (u ? "#" + u : ":scope") + " " + e$(f[a]);
                        v = f.join(",")
                    }
        ...
        for (t in i = el.support = {},
            ...
            d = el.setDocument = function (e) {
                ...
                return o != p && 9 === o.nodeType && o.documentElement && (f = (p = o).documentElement,
                    ...
                    v = [],
                    m = [],
                    (i.qsa = G.test(p.querySelectorAll)) && (eh(function (e) {
                        var t;
                    ...
                    $ = (t = G.test(f.compareDocumentPosition)) || G.test(f.contains) ? function (e, t) {
                    ...
                    A = t ? function (e, t) {
                        ...
                        : function (e, t) {
                            ...
                            if (!s || !r)
                                return e == p ? -1 : t == p ? 1 : s ? -1 : r ? 1 : u ? I(u, e) - I(u, t) : 0;
                            if (s === r)
                                return ep(e, t);
            ...
            el.matchesSelector = function (e, t) {
                if (d(e),
                    i.matchesSelector && g && !k[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t)))
                    try {
                        var n = y.call(e, t);
            ...
            (n = el.selectors = {
                ...
                preFilter: {
                    ATTR: function (e) {
                        return e[1] = e[1].replace(et, ei),
                            e[3] = (e[3] || e[4] || e[5] || "").replace(et, ei),
                            "~=" === e[2] && (e[3] = " " + e[3] + " "),
                            e.slice(0, 4)
                    },
                    CHILD: function (e) {
                    ...
                    PSEUDO: function (e) {
                        var t, i = !e[6] && e[2];
                        return K.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && X.test(i) && (t = o(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t),
                            e[2] = i.slice(0, t)),
                            e.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    ATTR: function (e, t, i) {
                        return function (n) {
                            var s = el.attr(n, e);
                            return null == s ? "!=" === t : !t || (s += "",
                                "=" === t ? s === i : "!=" === t ? s !== i : "^=" === t ? i && 0 === s.indexOf(i) : "*=" === t ? i && -1 < s.indexOf(i) : "$=" === t ? i && s.slice(-i.length) === i : "~=" === t ? -1 < (" " + s.replace(W, " ") + " ").indexOf(i) : "|=" === t && (s === i || s.slice(0, i.length + 1) === i + "-"))
                        }
                    },
                    CHILD: function (e, t, i, n, s) {
                        ...
                        return 1 === n && 0 === s ? function (e) {
                            ...
                            : function (t, i, l) {
                                var c, u, h, d, p, f, g = r !== o ? "nextSibling" : "previousSibling", m = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a, $ = !1;
                                if (m) {
                                    if (r) {
                                        for (; g;) {
                                            for (d = t; d = d[g];)
                                    ...
                                    if (f = [o ? m.firstChild : m.lastChild],
                                        o && y) {
                                        for ($ = (p = (c = (u = (h = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] || [])[0] === x && c[1]) && c[2],
                                            d = p && m.childNodes[p]; d = ++p && d && d[g] || ($ = p = 0) || f.pop();)
                                            if (1 === d.nodeType && ++$ && d === t) {
                                                u[e] = [x, p, $];
                                                break
                                            }
                                    } else if (y && ($ = p = (c = (u = (h = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] || [])[0] === x && c[1]),
                                        !1 === $)
                                        for (; (d = ++p && d && d[g] || ($ = p = 0) || f.pop()) && (!((a ? d.nodeName.toLowerCase() === v : 1 === d.nodeType) && ++$) || (y && ((u = (h = d[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] = [x, $]),
                                            d !== t));)
                                            ;
                                    return ($ -= s) === n || $ % n == 0 && 0 <= $ / n
                                }
                    ...
                    PSEUDO: function (e, t) {
                        ...
                        return s[b] ? s(t) : 1 < s.length ? (i = [e, e, "", t],
                ...
                pseudos: {
                    not: eu(function (e) {
                        ...
                        return n[b] ? eu(function (e, t, i, s) {
                            for (var r, o = n(e, null, s, []), a = e.length; a--;)
                                (r = o[a]) && (e[a] = !(t[a] = r))
                        }) : function (e, s, r) {
                            return t[0] = e,
                                n(t, null, r, i),
                    ...
                    lang: eu(function (e) {
                        return U.test(e || "") || el.error("unsupported lang: " + e),
            ...
            return t.first ? function (t, i, s) {
                ...
                : function (t, i, l) {
                    ...
                    if (l) {
                        ...
                        for (; t = t[n];)
                            if (1 === t.nodeType || o) {
                                if (u = (h = t[b] || (t[b] = {}))[t.uniqueID] || (h[t.uniqueID] = {}),
        ...
        function eC(e, t, i, n, s, r) {
            return n && !n[b] && (n = eC(n)),
                s && !s[b] && (s = eC(s, r)),
                eu(function (r, o, a, l) {
                    var c, u, h, d = [], p = [], f = o.length, g = r || function (e, t, i) {
                        for (var n = 0, s = t.length; n < s; n++)
                            el(e, t[n], i);
                        return i
                    }(t || "*", a.nodeType ? [a] : a, []), m = e && (r || !t) ? ex(g, d, e, a, l) : g, v = i ? s || (r ? e : f || n) ? [] : o : m;
                    if (i && i(m, v, a, l),
                        n)
                        for (c = ex(v, p),
                            n(c, [], a, l),
                    ...
                    if (r) {
                        if (s || e) {
                            ...
                            for (u = v.length; u--;)
                                (h = v[u]) && -1 < (c = s ? I(r, h) : d[u]) && (r[c] = !(o[c] = h))
                        }
                    } else
                        v = ex(v === o ? v.splice(f, v.length) : v),
                            s ? s(null, o, v, l) : O.apply(o, v)
                })
        }
        function e_(e) {
        ...
        return e8.prototype = n.filters = n.pseudos,
            n.setFilters = new e8,
            o = el.tokenize = function (e, t) {
                ...
                for (a = e,
                    l = [],
                    c = n.preFilter; a;) {
                    for (o in (!i || (s = F.exec(a))) && (s && (a = a.slice(s[0].length) || a),
                        l.push(r = [])),
                        i = !1,
                        (s = R.exec(a)) && (i = s.shift(),
                            r.push({
                                value: i,
                                type: s[0].replace(B, " ")
                            }),
                            a = a.slice(i.length)),
                        n.filter)
                        (s = K[o].exec(a)) && (!c[o] || (s = c[o](s))) && (i = s.shift(),
                            r.push({
                                value: i,
                                type: o,
                                matches: s
            ...
            a = el.compile = function (e, t) {
                var i, s, r, a, l, u, h = [], f = [], m = E[e + " "];
                if (!m) {
                    for (t || (t = o(e)),
                        i = t.length; i--;)
                        (m = e_(t[i]))[b] ? h.push(m) : f.push(m);
                    (m = E(e, (s = f,
                        a = 0 < (r = h).length,
                        l = 0 < s.length,
                        u = function (e, t, i, o, u) {
                            var h, f, m, v = 0, y = "0", $ = e && [], b = [], w = c, C = e || l && n.find.TAG("*", u), _ = x += null == w ? 1 : Math.random() || .1, T = C.length;
                            for (u && (c = t == p || t || u); y !== T && null != (h = C[y]); y++) {
                                if (l && h) {
                                    for (f = 0,
                                        t || h.ownerDocument == p || (d(h),
                                            i = !g); m = s[f++];)
                                        if (m(h, t || p, i)) {
                                            o.push(h);
                                            break
                            ...
                            if (v += y,
                                ...
                                O.apply(o, b),
                                    u && !e && 0 < b.length && 1 < v + r.length && el.uniqueSort(o)
                            }
                            return u && (x = _,
                                c = w),
                                $
            ...
            l = el.select = function (e, t, i, s) {
                var r, l, c, u, h, d = "function" == typeof e && e, p = !s && o(e = d.selector || e);
                if (i = i || [],
                    1 === p.length) {
                    if (2 < (l = p[0] = p[0].slice(0)).length && "ID" === (c = l[0]).type && 9 === t.nodeType && g && n.relative[l[1].type]) {
                        if (!(t = (n.find.ID(c.matches[0].replace(et, ei), t) || [])[0]))
                            return i;
                        d && (t = t.parentNode),
                ...
                return (d || a(e, p))(s, t, !g, i, !t || ee.test(e) && ey(t.parentNode) || t),
                    i
            }
            ,
    ...
    w.filter = function (e, t, i) {
        var n = t[0];
        return i && (e = ":not(" + e + ")"),
            1 === t.length && 1 === n.nodeType ? w.find.matchesSelector(n, e) ? [n] : [] : w.find.matches(e, w.grep(t, function (e) {
                return 1 === e.nodeType
            }))
    }
        ,
    ...
    (w.fn.init = function (e, t, i) {
        ...
        return e.nodeType ? (this[0] = e,
            this.length = 1,
            this) : f(e) ? void 0 !== i.ready ? i.ready(e) : e(w) : w.makeArray(e, this)
    }
    ).prototype = w.fn,
        D = w(m);
    ...
    w.fn.extend({
        ...
        closest: function (e, t) {
            var i, n = 0, s = this.length, r = [], o = "string" != typeof e && w(e);
            if (!E.test(e)) {
                for (; n < s; n++)
        ...
        w.each({
            ...
            w.fn[e] = function (i, n) {
                ...
                return "Until" !== e.slice(-5) && (n = i),
                    ...
                    1 < this.length && (O[e] || w.uniqueSort(s),
                        N.test(e) && s.reverse()),
                    this.pushStack(s)
            }
        });
    ...
    w.Callbacks = function (e) {
        e = "string" == typeof e ? (t = e,
            ...
            i) : w.extend({}, e);
        var t, i, n, s, r, o, a = [], l = [], c = -1, u = function () {
            for (o = o || e.once,
                r = n = !0; l.length; c = -1)
        ...
        w.extend({
                    ...
                    , s = {
                        ...
                        then: function (t, n, s) {
                                    ...
                                    var a = this
                                        ...
                                        , c = function () {
                                            ...
                                            if (!(t < r)) {
                                                ...
                                                f(c = e && ("object" == typeof e || "function" == typeof e) && e.then) ? s ? c.call(e, o(r, i, j, s), o(r, i, z, s)) : (r++,
                                                    c.call(e, o(r, i, j, s), o(r, i, z, s), o(r, i, j, i.notifyWith))) : (n !== j && (a = void 0,
                                                        l = [e]),
                                                        (s || i.resolveWith)(a, l))
                                            }
                                        }
                            ...
                            return w.Deferred(function (e) {
                                i[0][3].add(o(0, e, f(s) ? s : j, e.notifyWith)),
                                    i[1][3].add(o(0, e, f(t) ? t : j)),
                                    i[2][3].add(o(0, e, f(n) ? n : z))
                            }).promise()
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && (H(e, o.done(a(i)).resolve, o.reject, !t),
    ...
    w.fn.ready = function (e) {
        ...
        w.ready.then = q.then,
        "complete" !== m.readyState && ("loading" === m.readyState || m.documentElement.doScroll) ? (m.addEventListener("DOMContentLoaded", W),
            e.addEventListener("load", W)) : e.setTimeout(w.ready);
    ...
    K.uid = 1,
        K.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== t)
                        for (i = (t = Array.isArray(t) ? t.map(X) : ((t = X(t)) in n) ? [t] : t.match(I) || []).length; i--;)
                            delete n[t[i]];
    ...
    function J(e, t, i) {
        ...
        if (void 0 === i && 1 === e.nodeType) {
            if (n = "data-" + t.replace(G, "-$&").toLowerCase(),
    ...
    w.extend({
        ...
        w.fn.extend({
            data: function (e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (s = Y.get(r),
                        1 === r.nodeType && !Q.get(r, "hasDataAttrs"))) {
                        for (i = o.length; i--;)
                            o[i] && 0 === (n = o[i].name).indexOf("data-") && J(r, n = X(n.slice(5)), s[n]);
                ...
                return "object" == typeof e ? this.each(function () {
                    ...
                    var i;
                    if (r && void 0 === t)
                        return void 0 !== (i = Y.get(r, e)) ? i : void 0 !== (i = J(r, e)) ? i : void 0;
                    this.each(function () {
                        Y.set(this, e, t)
                    })
        ...
        w.extend({
            queue: function (e, t, i) {
                ...
                if (e)
                    return t = (t || "fx") + "queue",
                        n = Q.get(e, t),
                        i && (!n || Array.isArray(i) ? n = Q.access(e, t, w.makeArray(i)) : n.push(i)),
                        n || []
            },
        ...
        w.fn.extend({
            queue: function (e, t) {
                ...
                return "string" != typeof e && (t = e,
                    e = "fx",
                    i--),
                    arguments.length < i ? w.queue(this[0], e) : void 0 === t ? this : this.each(function () {
            ...
            promise: function (e, t) {
                ...
                for ("string" != typeof e && (t = e,
                    e = void 0),
                    e = e || "fx"; o--;)
                    (i = Q.get(r[o], e + "queueHooks")) && i.empty && (n++,
                        i.empty.add(a));
                return a(),
                    s.promise(t)
            }
    ...
    function ea(e, t, i, n) {
        var s, r, o = 20, a = n ? function () {
            ...
            , l = a(), c = i && i[3] || (w.cssNumber[t] ? "" : "px"), u = e.nodeType && (w.cssNumber[t] || "px" !== c && +l) && et.exec(w.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
                c = c || u[3],
                u = +l || 1; o--;)
    ...
    function ec(e, t) {
        for (var i, n, s, r, o, a, l, c = [], u = 0, h = e.length; u < h; u++)
            (n = e[u]).style && (i = n.style.display,
                t ? ("none" === i && (c[u] = Q.get(n, "display") || null,
                    c[u] || (n.style.display = "")),
                    "" === n.style.display && eo(n) && (c[u] = (l = o = r = void 0,
                        o = (s = n).ownerDocument,
                        (l = el[a = s.nodeName]) || (r = o.body.appendChild(o.createElement(a)),
                            l = w.css(r, "display"),
                            r.parentNode.removeChild(r),
                            "none" === l && (l = "block"),
                            el[a] = l)))) : "none" !== i && (c[u] = "none",
                                Q.set(n, "display", i)));
        for (u = 0; u < h; u++)
    ...
    var eu, eh, ed = /^(?:checkbox|radio)$/i, ep = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, ef = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    eg.tbody = eg.tfoot = eg.colgroup = eg.caption = eg.thead,
        eg.th = eg.td,
        p.option || (eg.optgroup = eg.option = [1, "<select multiple='multiple'>", "</select>"]);
    var ey = /<|&#?\w+;/;
    function e8(e, t, i, n, s) {
            ...
            if ((r = e[p]) || 0 === r) {
                if ("object" === $(r))
                    ...
                    for (o = o || h.appendChild(t.createElement("div")),
                        l = eg[a = (ep.exec(r) || ["", ""])[1].toLowerCase()] || eg._default,
        ...
        for (h.textContent = "",
            ...
            if (n && -1 < w.inArray(r, n))
                ...
                o = em(h.appendChild(r), "script"),
                c && ev(o),
                i)
                for (u = 0; r = o[u++];)
                    ef.test(r.type || "") && i.push(r);
        return h
    }
    var e$ = /^([^.]*)(?:\.(.+)|)/;
    function eb() {
                ...
                handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        if (o.length)
                            ...
                            n = i(this, t),
                            this[t](),
                            o !== (r = Q.get(this, t)) || n ? Q.set(this, t, !1) : r = {},
                            o !== r)
    ...
    w.event = {
                    ...
                    p = g = (a = e$.exec(t[c]) || [])[1],
                        ...
                        p && (h = w.event.special[p] || {},
                            ...
                            (d = l[p]) || ((d = l[p] = []).delegateCount = 0,
                                h.setup && !1 !== h.setup.call(e, n, f, o) || e.addEventListener && e.addEventListener(p, o)),
                ...
                for (c = (t = (t || "").match(I) || [""]).length; c--;)
                    if (p = g = (a = e$.exec(t[c]) || [])[1],
                        ...
                        for (h = w.event.special[p] || {},
                            ...
                            o = r = d.length; r--;)
                            u = d[r],
                                !s && g !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(r, 1),
                                    u.selector && d.delegateCount--,
                                    h.remove && h.remove.call(e, u));
                        o && !d.length && (h.teardown && !1 !== h.teardown.call(e, f, m.handle) || w.removeEvent(e, p, m.handle),
                            delete l[p])
                    } else
                        for (p in l)
                            w.event.remove(e, p + t[c], i, n, !0);
                w.isEmptyObject(l) && Q.remove(e, "handle events")
            }
        },
        dispatch: function (e) {
            var t, i, n, s, r, o, a = Array(arguments.length), l = w.event.fix(e), c = (Q.get(this, "events") || Object.create(null))[l.type] || [], u = w.event.special[l.type] || {};
            for (a[0] = l,
                t = 1; t < arguments.length; t++)
                a[t] = arguments[t];
            if (l.delegateTarget = this,
                !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                for (o = w.event.handlers.call(this, l, c),
                    ...
                    for (l.currentTarget = s.elem,
                        ...
                        l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace) || (l.handleObj = r,
                            l.data = r.data,
                            void 0 !== (n = ((w.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, a)) && !1 === (l.result = n) && (l.preventDefault(),
                                l.stopPropagation()));
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [],
                            o = {},
                            i = 0; i < l; i++)
                            void 0 === o[s = (n = t[i]).selector + " "] && (o[s] = n.needsContext ? -1 < w(s, this).index(c) : w.find(s, this, null, [c]).length),
                                o[s] && r.push(n);
                        r.length && a.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return ed.test(t.type) && t.click && k(t, "input") && e_(t, "click", eb),
                        !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return ed.test(t.type) && t.click && k(t, "input") && e_(t, "click"),
                        !0
                },
                _default: function (e) {
                    var t = e.target;
        ...
        w.each({
            ...
            w.event.special[e] = {
                ...
                handle: function (e) {
                    ...
                    return n && (n === this || w.contains(this, n)) || (e.type = s.origType,
    ...
    function eL(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Q.hasData(e) && (a = Q.get(e).events))
                for (s in Q.remove(t, "handle events"),
                    a)
                    for (i = 0,
                        n = a[s].length; i < n; i++)
                        w.event.add(t, s, a[s][i]);
    ...
    function e9(e, t, i, n) {
        t = r(t);
        var s, o, a, l, c, u, h = 0, d = e.length, g = d - 1, m = t[0], v = f(m);
        if (v || 1 < d && "string" == typeof m && !p.checkClone && eE.test(m))
            return e.each(function (s) {
                var r = e.eq(s);
                v && (t[0] = m.call(this, s, r.html())),
                    e9(r, t, i, n)
            });
        if (d && (o = (s = e8(t, e[0].ownerDocument, !1, e, n)).firstChild,
            1 === s.childNodes.length && (s = o),
            o || n)) {
            for (l = (a = w.map(em(s, "script"), eS)).length; h < d; h++)
                c = s,
                    h !== g && (c = w.clone(c, !0, !0),
            ...
            if (l)
                for (u = a[a.length - 1].ownerDocument,
                    ...
                    h = 0; h < l; h++)
                    c = a[h],
                        ef.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    function eN(e, t, i) {
        for (var n, s = t ? w.filter(t, e) : e, r = 0; null != (n = s[r]); r++)
            i || 1 !== n.nodeType || w.cleanData(em(n)),
                n.parentNode && (i && es(n) && ev(em(n, "script")),
    ...
    w.extend({
        ...
        clone: function (e, t, i) {
            var n, s, r, o, a, l, c, u = e.cloneNode(!0), h = es(e);
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (o = em(u),
                    n = 0,
                    s = (r = em(e)).length; n < s; n++)
                    a = r[n],
                        "input" === (c = (l = o[n]).nodeName.toLowerCase()) && ed.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t) {
                if (i)
                    for (r = r || em(e),
                        o = o || em(u),
            ...
            return 0 < (o = em(u, "script")).length && ev(o, !h && em(e, "script")),
                u
        },
        ...
        w.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType && (w.cleanData(em(e, !1)),
                        e.textContent = "");
                return this
            },
            clone: function (e, t) {
            ...
            html: function (e) {
                return B(this, function (e) {
                    ...
                    if ("string" == typeof e && !eT.test(e) && !eg[(ep.exec(e) || ["", ""])[1].toLowerCase()]) {
                        ...
                        try {
                            for (; i < n; i++)
                                1 === (t = this[i] || {}).nodeType && (w.cleanData(em(t, !1)),
                                    t.innerHTML = e);
                            t = 0
                        } catch (s) { }
                    }
            ...
            replaceWith: function () {
                ...
                return e9(this, arguments, function (t) {
                    ...
                    0 > w.inArray(this, e) && (w.cleanData(em(this)),
        ...
        w.each({
            ...
            w.fn[e] = function (e) {
                for (var i, n = [], s = w(e), r = s.length - 1, a = 0; a <= r; a++)
    ...
    var eO = RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i")
        ...
        , eM = RegExp("^" + eH + "+|((?:^|[^\\\\])(?:\\\\.)*)" + eH + "+$", "g");
    function eq(e, t, i) {
        var n, s, r, o, a = eP.test(t), l = e.style;
        return (i = i || eI(e)) && (o = i.getPropertyValue(t) || i[t],
            a && o && (o = o.replace(eM, "$1") || void 0),
            "" !== o || es(e) || (o = w.style(e, t)),
            !p.pixelBoxStyles() && eO.test(o) && ez.test(t) && (n = l.width,
                s = l.minWidth,
                r = l.maxWidth,
    ...
    function eK(e, t, i, n, s, r) {
        ...
        for (; o < 4; o += 2)
            "margin" === i && (l += w.css(e, i + ei[o], !0, s)),
                n ? ("content" === i && (l -= w.css(e, "padding" + ei[o], !0, s)),
                    "margin" !== i && (l -= w.css(e, "border" + ei[o] + "Width", !0, s))) : (l += w.css(e, "padding" + ei[o], !0, s),
                        "padding" !== i ? l += w.css(e, "border" + ei[o] + "Width", !0, s) : a += w.css(e, "border" + ei[o] + "Width", !0, s));
    ...
    function e3(e, t, i) {
        ...
        return (!p.boxSizingReliable() && s || !p.reliableTrDimensions() && k(e, "tr") || "auto" === o || !parseFloat(o) && "inline" === w.css(e, "display", !1, n)) && e.getClientRects().length && (s = "border-box" === w.css(e, "boxSizing", !1, n),
            (r = a in e) && (o = e[a])),
    ...
    w.extend({
        ...
        style: function (e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s, r, o, a = X(t), l = eP.test(t), c = e.style;
                if (l || (t = eR(a)),
                    o = w.cssHooks[t] || w.cssHooks[a],
                    void 0 === i)
                    return o && "get" in o && void 0 !== (s = o.get(e, !1, n)) ? s : c[t];
                "string" == (r = typeof i) && (s = et.exec(i)) && s[1] && (i = ea(e, t, s),
                    r = "number"),
                    null != i && i == i && ("number" !== r || l || (i += s && s[3] || (w.cssNumber[a] ? "" : "px")),
        ...
        w.each(["height", "width"], function (e, t) {
            w.cssHooks[t] = {
                get: function (e, i, n) {
                    if (i)
                        return !e1.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? e3(e, t, n) : ej(e, eV, function () {
                            return e3(e, t, n)
                        })
                },
                set: function (e, i, n) {
                    var s, r = eI(e), o = !p.scrollboxSize() && "absolute" === r.position, a = (o || n) && "border-box" === w.css(e, "boxSizing", !1, r), l = n ? eK(e, t, n, a, r) : 0;
                    return a && o && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - eK(e, t, "border", !1, r) - .5)),
                        l && (s = et.exec(i)) && "px" !== (s[3] || "px") && (e.style[t] = i,
                            i = w.css(e, t)),
                        eU(0, i, l)
                }
            }
        ...
        w.cssHooks.marginLeft = eW(p.reliableMarginLeft, function (e, t) {
            if (t)
                return (parseFloat(eq(e, "marginLeft")) || e.getBoundingClientRect().left - ej(e, {
                    marginLeft: 0
                }, function () {
        ...
        w.fx.step = {};
    var eY, e2, e4, e7, eZ = /^(?:toggle|show|hide)$/, eG = /queueHooks$/;
    function e5() {
    ...
    function te(e, t, i) {
        var n, s, r = 0, o = te.prefilters.length, a = w.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (s)
                return !1;
            for (var t = eY || e5(), i = Math.max(0, c.startTime + c.duration - t), n = 1 - (i / c.duration || 0), r = 0, o = c.tweens.length; r < o; r++)
                c.tweens[r].run(n);
            return a.notifyWith(e, [c, n, i]),
                n < 1 && o ? i : (o || a.notifyWith(e, [c, 1, 0]),
                    a.resolveWith(e, [c]),
                    !1)
        }, c = a.promise({
            elem: e,
        ...
        for (function (e, t) {
            ...
            if (n = te.prefilters[r].call(c, e, u, c.opts))
                return f(n.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)),
                    n;
        return w.map(u, eJ, c),
    ...
    w.Animation = w.extend(te, {
        tweeners: {
            "*": [function (e, t) {
                ...
                return ea(i.elem, e, et.exec(t), i),
                    i
            }
            ]
        },
        tweener: function (e, t) {
            ...
            for (var i, n = 0, s = e.length; n < s; n++)
                i = e[n],
                    te.tweeners[i] = te.tweeners[i] || [],
                    te.tweeners[i].unshift(t)
        },
        prefilters: [function (e, t, i) {
            var n, s, r, o, a, l, c, u, h = "width" in t || "height" in t, d = this, p = {}, f = e.style, g = e.nodeType && eo(e), m = Q.get(e, "fxshow");
            for (n in i.queue || (null == (o = w._queueHooks(e, "fx")).unqueued && (o.unqueued = 0,
                a = o.empty.fire,
            ...
            if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(p))
                for (n in h && 1 === e.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY],
                    ...
                    "none" === (u = w.css(e, "display")) && (c ? u = c : (ec([e], !0),
                        c = e.style.display || c,
                        u = w.css(e, "display"),
                        ec([e]))),
        ...
        w.fn.extend({
            ...
            finish: function (e) {
                return !1 !== e && (e = e || "fx"),
                    this.each(function () {
                        var t, i = Q.get(this), n = i[e + "queue"], s = i[e + "queueHooks"], r = w.timers, o = n ? n.length : 0;
                        for (i.finish = !0,
                            w.queue(this, e, []),
        ...
        w.fx.start = function () {
            e2 || (e2 = !0,
                function t() {
                    e2 && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(t) : e.setTimeout(t, w.fx.interval),
                        w.fx.tick())
                }())
        }
        ,
    ...
    w.fn.extend({
        ...
        w.extend({
            attr: function (e, t, i) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return void 0 === e.getAttribute ? w.prop(e, t, i) : (1 === r && w.isXMLDoc(e) || (s = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? tt : void 0)),
                        void 0 !== i ? null === i ? void w.removeAttr(e, t) : s && "set" in s && void 0 !== (n = s.set(e, i, t)) ? n : (e.setAttribute(t, i + ""),
                            i) : s && "get" in s && null !== (n = s.get(e, t)) ? n : null == (n = w.find.attr(e, t)) ? void 0 : n)
            },
            attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        tt = {
            set: function (e, t, i) {
                return !1 === t ? w.removeAttr(e, i) : e.setAttribute(i, i),
                    i
            }
        },
    ...
    w.fn.extend({
        ...
        w.fn.extend({
            ...
            toggleClass: function (e, t) {
                var i, n, s, r, o = typeof e, a = "string" === o || Array.isArray(e);
                return f(e) ? this.each(function (i) {
                    w(this).toggleClass(e.call(this, i, to(this), t), t)
                }) : "boolean" == typeof t && a ? t ? this.addClass(e) : this.removeClass(e) : (i = ta(e),
                    this.each(function () {
                        if (a)
                            for (r = w(this),
                                s = 0; s < i.length; s++)
                            ...
                            void 0 !== e && "boolean" !== o || ((n = to(this)) && Q.set(this, "__className__", n),
                                this.setAttribute && this.setAttribute("class", n || !1 === e ? "" : Q.get(this, "__className__") || ""))
                    }))
            },
            hasClass: function (e) {
                var t, i, n = 0;
                for (t = " " + e + " "; i = this[n++];)
                    if (1 === i.nodeType && -1 < (" " + tr(to(i)) + " ").indexOf(t))
                        return !0;
                return !1
            }
        });
    ...
    w.fn.extend({
        ...
        w.extend({
            valHooks: {
                ...
                select: {
                    get: function (e) {
                        var t, i, n, s = e.options, r = e.selectedIndex, o = "select-one" === e.type, a = o ? null : [], l = o ? r + 1 : s.length;
                    ...
                    set: function (e, t) {
                        for (var i, n, s = e.options, r = w.makeArray(t), o = s.length; o--;)
                            ((n = s[o]).selected = -1 < w.inArray(w.valHooks.option.get(n), r)) && (i = !0);
    ...
    w.extend(w.event, {
        trigger: function (t, i, n, s) {
            var r, o, a, l, c, h, d, p, v = [n || m], y = u.call(t, "type") ? t.type : t, $ = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = p = a = n = n || m,
                3 !== n.nodeType && 8 !== n.nodeType && !tc.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = ($ = y.split(".")).shift(),
                    $.sort()),
                    c = 0 > y.indexOf(":") && "on" + y,
                ...
                if (!s && !d.noBubble && !g(n)) {
                    for (l = d.delegateType || y,
                        tc.test(l + y) || (o = o.parentNode); o; o = o.parentNode)
                        v.push(o),
                            a = o;
                ...
                for (r = 0; (o = v[r++]) && !t.isPropagationStopped();)
                    p = o,
                        ...
                        (h = c && o[c]) && h.apply && U(o) && (t.result = h.apply(o, i),
                            !1 === t.result && t.preventDefault());
                return t.type = y,
                    s || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), i) || !U(n) || c && f(n[y]) && !g(n) && ((a = n[c]) && (n[c] = null),
                        w.event.triggered = y,
        ...
        p.focusin || w.each({
            ...
            w.event.special[t] = {
                ...
                teardown: function () {
                    var n = this.ownerDocument || this.document || this
                        , s = Q.access(n, t) - 1;
                    s ? Q.access(n, t, s) : (n.removeEventListener(e, i, !0),
                        Q.remove(n, t))
                }
            }
        });
    ...
    w.parseXML = function (t) {
        ...
        return n = i && i.getElementsByTagName("parsererror")[0],
            i && !n || w.error("Invalid XML: " + (n ? w.map(n.childNodes, function (e) {
                return e.textContent
            }).join("\n") : t)),
            i
    }
    ...
    function tA(e) {
        return function (t, i) {
            "string" != typeof t && (i = t,
                t = "*");
            var n, s = 0, r = t.toLowerCase().match(I) || [];
            if (f(i))
                for (; n = r[s++];)
        ...
        w.extend({
            ...
            ajax: function (t, i) {
                "object" == typeof t && (i = t,
                    t = void 0),
                    i = i || {};
                var n, s, r, o, a, l, c, u, h, d, p = w.ajaxSetup({}, i), f = p.context || p, g = p.context && (f.nodeType || f.jquery) ? w(f) : w.event, v = w.Deferred(), y = w.Callbacks("once memory"), $ = p.statusCode || {}, b = {}, x = {}, C = "canceled", _ = {
                    readyState: 0,
                    ...
                    setRequestHeader: function (e, t) {
                        return null == c && (b[e = x[e.toLowerCase()] = x[e.toLowerCase()] || e] = t),
                            this
                    },
                ...
                if (v.promise(_),
                    ...
                    try {
                        l.href = p.url,
                            l.href = l.href,
                            p.crossDomain = tk.protocol + "//" + tk.host != l.protocol + "//" + l.host
                    } catch (T) {
                        p.crossDomain = !0
                    }
                }
                ...
                for (h in (u = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                    ...
                    s = p.url.replace(t$, ""),
                    p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(t8, "+")) : (d = p.url.slice(s.length),
                        p.data && (p.processData || "string" == typeof p.data) && (s += (tp.test(s) ? "&" : "?") + p.data,
                            delete p.data),
                        !1 === p.cache && (s = s.replace(tb, "$1"),
                            d = (tp.test(s) ? "&" : "?") + "_=" + td.guid++ + d),
                        p.url = s + d),
                    p.ifModified && (w.lastModified[s] && _.setRequestHeader("If-Modified-Since", w.lastModified[s]),
                        w.etag[s] && _.setRequestHeader("If-None-Match", w.etag[s])),
                ...
                function k(t, i, o, l) {
                    ...
                    c || (c = !0,
                        ...
                        h = 200 <= t && t < 300 || 304 === t,
                        o && (b = function (e, t, i) {
                            for (var n, s, r, o, a = e.contents, l = e.dataTypes; "*" === l[0];)
                                l.shift(),
                        ...
                        h ? (p.ifModified && ((x = _.getResponseHeader("Last-Modified")) && (w.lastModified[s] = x),
                            (x = _.getResponseHeader("etag")) && (w.etag[s] = x)),
                        ...
                        i = function (e) {
                            return function () {
                                i && (i = n = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null,
                                    "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(tL[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                        binary: a.response
                                    } : {
                                        text: a.responseText
    ...
    w.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = tO.pop() || w.expando + "_" + td.guid++;
            return this[e] = !0,
                e
        }
    }),
        w.ajaxPrefilter("json jsonp", function (t, i, n) {
            var s, r, o, a = !1 !== t.jsonp && (tP.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && tP.test(t.data) && "data");
            if (a || "jsonp" === t.dataTypes[0])
                return s = t.jsonpCallback = f(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                    a ? t[a] = t[a].replace(tP, "$1" + s) : !1 !== t.jsonp && (t.url += (tp.test(t.url) ? "&" : "?") + t.jsonp + "=" + s),
        ...
        p.createHTMLDocument = ((tN = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
            2 === tN.childNodes.length),
        w.parseHTML = function (e, t, i) {
            var n, s, r;
            return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t,
                t = !1),
                t || (p.createHTMLDocument ? ((n = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href,
                    t.head.appendChild(n)) : t = m),
                r = !i && [],
                (s = A.exec(e)) ? [t.createElement(s[1])] : (s = e8([e], t, r),
        ...
        w.fn.load = function (e, t, i) {
            ...
            return -1 < a && (n = tr(e.slice(a)),
                ...
                0 < o.length && w.ajax({
                    ...
                    r = arguments,
                        o.html(n ? w("<div>").append(w.parseHTML(e)).find(n) : e)
        ...
        w.offset = {
            setOffset: function (e, t, i) {
                var n, s, r, o, a, l, c = w.css(e, "position"), u = w(e), h = {};
                "static" === c && (e.style.position = "relative"),
                    a = u.offset(),
                    r = w.css(e, "top"),
                    l = w.css(e, "left"),
                    ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (o = (n = u.position()).top,
            ...
            position: function () {
                if (this[0]) {
                    ...
                    if ("fixed" === w.css(n, "position"))
                        ...
                        for (t = this.offset(),
                            i = n.ownerDocument,
                            e = n.offsetParent || i.documentElement; e && (e === i.body || e === i.documentElement) && "static" === w.css(e, "position");)
                            e = e.parentNode;
                        e && e !== n && 1 === e.nodeType && ((s = w(e).offset()).top += w.css(e, "borderTopWidth", !0),
                ...
                w.fn[n] = function (s, r) {
                    ...
                    return B(this, function (t, i, s) {
                        ...
                        return g(t) ? 0 === n.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement,
                            Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === s ? w.css(t, i, a) : w.style(t, i, s, a)
                    }, t, o ? s : void 0, o)
                }
            })
        }),
    ...
    function (e, t) {
        ...
        var e = "undefined" != typeof window
            ...
            , r = function e(t, i) {
                var n, s = "LazyLoad::Initialized", r = new t(i);
                try {
                    n = new CustomEvent(s, {
                        detail: {
                            instance: r
            ...
            , m = function e(t, i) {
                t._loadingCount += i,
                    0 === t._elements.length && 0 === t._loadingCount && g(t._settings.callback_finish)
            }
            , v = function e(t) {
            ...
            , x = function e(t, i) {
                var n, s, r = i._settings, o = w[t.tagName];
                if (o) {
                    o(t, r),
                        m(i, 1),
                        i._elements = (n = i._elements,
                            s = t,
                            n.filter(function (e) {
                                return e !== s
                            }));
            ...
            , j = function e(t, i) {
                var n = i._observer;
                q(t, i),
                    n && i._settings.auto_unobserve && n.unobserve(t)
            }
            , z = function e(t, i) {
                var n = i._settings;
                g(n.callback_exit, t),
            ...
            , q = function e(t, i, n) {
                var s, r = i._settings;
                !(!n && d(t)) && (P.indexOf(t.tagName) > -1 && (O(t, i),
                    C(t, r.class_loading)),
                    x(t, i),
                    h(s = t, a, c),
            ...
            , F = function e(t) {
                t._elements.forEach(function (e) {
                    -1 !== B.indexOf(e.tagName) && (e.setAttribute("loading", "lazy"),
                        q(e, t))
                })
            }
            , R = function e(t, i) {
                var n, s, r;
                return (r = (s = t || (n = i).container.querySelectorAll(n.elements_selector),
        ...
        return V.prototype = {
            update: function e(i) {
                ...
                if (this._elements = R(i, r),
                    t || !this._observer) {
                    this.loadAll();
                    return
                }
                (n = r).use_native && "loading" in HTMLImageElement.prototype && (F(this),
                    this._elements = R(i, r)),
        ...
        s.Defaults = {
            ...
            s.Workers = [{
                ...
                run: function () {
                    for (var e = this.settings.rtl ? 1 : -1, t = this._clones.length + this._items.length, i = -1, n = 0, s = 0, r = []; ++i < t;)
                        n = r[i - 1] || 0,
                            r.push(n + (s = this._widths[this.relative(i)] + this.settings.margin) * e);
                    this._coordinates = r
                }
            }, {
                filter: ["width", "items", "settings"],
                ...
                run: function () {
                    var e, t, i, n, s = this.settings.rtl ? 1 : -1, r = 2 * this.settings.stagePadding, o = this.coordinates(this.current()) + r, a = o + this.width() * s, l = [];
                    for (i = 0,
                        n = this._coordinates.length; i < n; i++)
                        e = this._coordinates[i - 1] || 0,
                            t = Math.abs(this._coordinates[i]) + r * s,
                            (this.op(e, "<=", o) && this.op(e, ">", a) || this.op(t, "<", o) && this.op(t, ">", a)) && l.push(i);
            ...
            s.prototype.initialize = function () {
                if (this.enter("initializing"),
                    ...
                    e = this.$element.find("img"),
                        t = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector : n,
            ...
            s.prototype.setup = function () {
                ...
                i ? (e.each(i, function (e) {
                    ...
                    delete s.responsive,
                    s.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(RegExp("(" + this.options.responsiveClass + "-)\\S+\\s", "g"), "$1" + n))) : s = e.extend({}, this.options),
                    this.trigger("change", {
                        property: {
                            name: "settings",
                            value: s
            ...
            s.prototype.update = function () {
                for (var t = 0, i = this._pipe.length, n = e.proxy(function (e) {
                    return this[e]
                }, this._invalidated), s = {}; t < i;)
                    (this._invalidated.all || e.grep(this._pipe[t].filter, n).length > 0) && this._pipe[t].run(s),
                        t++;
                this._invalidated = {},
            ...
            s.prototype.closest = function (t, i) {
                ...
                return this.settings.freeDrag || e.each(o, e.proxy(function (e, a) {
                    return "left" === i && t > a - 30 && t < a + 30 ? s = e : "right" === i && t > a - r - 30 && t < a - r + 30 ? s = e + 1 : this.op(t, "<", a) && this.op(t, ">", n !== o[e + 1] ? o[e + 1] : a - r) && (s = "left" === i ? e + 1 : e),
                        -1 === s
                }, this)),
            ...
            s.prototype.reset = function (e) {
                n !== (e = this.normalize(e)) && (this._speed = 0,
                    this._current = e,
            ...
            s.prototype.maximum = function (e) {
                ...
                if (s.loop)
                    ...
                    if (t = this._items.length)
                        for (i = this._items[--t].width(),
                            n = this.$element.width(); t-- && !((i += this._items[t].width() + this.settings.margin) > n);)
                            ;
                    r = t + 1
                } else
            ...
            s.prototype.items = function (e) {
                return e === n ? this._items.slice() : (e = this.normalize(e, !0),
                    this._items[e])
            }
            ,
            s.prototype.mergers = function (e) {
                return e === n ? this._mergers.slice() : (e = this.normalize(e, !0),
                    this._mergers[e])
            }
            ,
            ...
            s.prototype.coordinates = function (t) {
                ...
                return t === n ? e.map(this._coordinates, e.proxy(function (e, t) {
                    ...
                    i += (this.width() - i + (this._coordinates[r] || 0)) / 2 * s) : i = this._coordinates[r] || 0,
                    i = Math.ceil(i))
            }
            ,
            ...
            s.prototype.to = function (e, t) {
                var i = this.current()
                    ...
                    , a = this.minimum()
                    , l = this.maximum();
                this.settings.loop ? (!this.settings.rewind && Math.abs(s) > o / 2 && (s += -1 * r * o),
                    (n = (((e = i + s) - a) % o + o) % o + a) !== e && n - s <= l && n - s > 0 && (i = n - s,
                        e = n,
            ...
            s.prototype.viewport = function () {
                var n;
                return this.options.responsiveBaseElement !== t ? n = e(this.options.responsiveBaseElement).width() : t.innerWidth ? n = t.innerWidth : i.documentElement && i.documentElement.clientWidth ? n = i.documentElement.clientWidth : console.warn("Can not detect viewport width."),
                    n
            }
            ,
            ...
            s.prototype.enter = function (t) {
                e.each([t].concat(this._states.tags[t] || []), e.proxy(function (e, t) {
                    n === this._states.current[t] && (this._states.current[t] = 0),
            ...
            s.prototype.register = function (t) {
                if (t.type === s.Type.Event) {
                    ...
                    t.type === s.Type.State && (this._states.tags[t.name] ? this._states.tags[t.name] = this._states.tags[t.name].concat(t.tags) : this._states.tags[t.name] = t.tags,
            ...
            s.prototype.pointer = function (e) {
                ...
                return (e = (e = e.originalEvent || e || t.event).touches && e.touches.length ? e.touches[0] : e.changedTouches && e.changedTouches.length ? e.changedTouches[0] : e).pageX ? (i.x = e.pageX,
            ...
            e.fn.owlCarousel = function (t) {
                ...
                return this.each(function () {
                    ...
                    r || (r = new s(this, "object" == typeof t && t),
        ...
        s.Defaults = {
            ...
            s.prototype.load = function (i) {
                ...
                !(!s || e.inArray(n.get(0), this._loaded) > -1) && (s.each(e.proxy(function (i, n) {
                    var s, r = e(n), o = t.devicePixelRatio > 1 && r.attr("data-src-retina") || r.attr("data-src") || r.attr("data-srcset");
    ...
    function (e, t, i, n) {
        ...
        s.Defaults = {
            ...
            s.prototype.thumbnail = function (t, i) {
                var n, s, r, o = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "", a = t.find("img"), l = "src", c = "", u = this._core.settings, h = function (i) {
            ...
            s.prototype.play = function (t) {
                var i, n, s = e(t.target).closest("." + this._core.settings.itemClass), r = this._videos[s.attr("data-video")], o = r.width || "100%", a = r.height || this._core.$stage.height();
    ...
    function (e, t, i, n) {
        ...
        s.Defaults = {
            ...
            ,
            s.prototype.update = function () {
                var e, t, i, n = this._core.clones().length / 2, s = n + this._core.items().length, r = this._core.maximum(!0), o = this._core.settings, a = o.center || o.autoWidth || o.dotsData ? 1 : o.dotsEach || o.items;
            ...
            s.prototype.draw = function () {
                var t, i = this._core.settings, n = this._core.items().length <= i.items, s = this._core.relative(this._core.current()), r = i.loop || i.rewind;
                this._controls.$relative.toggleClass("disabled", !i.nav || n),
                    i.nav && (this._controls.$previous.toggleClass("disabled", !r && s <= this._core.minimum(!0)),
                        this._controls.$next.toggleClass("disabled", !r && s >= this._core.maximum(!0))),
                    this._controls.$absolute.toggleClass("disabled", !i.dots || n),
                    i.dots && (t = this._pages.length - this._controls.$absolute.children().length,
                        i.dotsData && 0 !== t ? this._controls.$absolute.html(this._templates.join("")) : t > 0 ? this._controls.$absolute.append(Array(t + 1).join(this._templates[0])) : t < 0 && this._controls.$absolute.children().slice(t).remove(),
            ...
            s.prototype.getPosition = function (t) {
                ...
                return "page" == s.slideBy ? (i = e.inArray(this.current(), this._pages),
            ...
            s.prototype.to = function (t, i, n) {
                ...
                !n && this._pages.length ? (s = this._pages.length,
                    e.proxy(this._overrides.to, this._core)(this._pages[(t % s + s) % s].start, i)) : e.proxy(this._overrides.to, this._core)(t, i)
            }
            ,
    ...
    function (e, t, i, n) {
        ...
        a.csstransitions() && (e.support.transition = new String(c("transition")),
            e.support.transition.end = o.transition.end[e.support.transition]),
            a.cssanimations() && (e.support.animation = new String(c("animation")),
                e.support.animation.end = o.animation.end[e.support.animation]),
            a.csstransforms() && (e.support.transform = new String(c("transform")),
    ...
    function (e, t) {
            ...
            _typeCheckConfig(e, i = this.constructor.DefaultType) {
                for (let n of Object.keys(i)) {
                    let s = i[n]
                        ...
                        , o = l(r) ? "element" : t(r);
                    if (!RegExp(s).test(o))
                        throw TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${n}" provided type "${o}" but expected type "${s}".`)
                }
            }
        }
        class X extends V {
        ...
        class e9 extends X {
            ...
            _addEventListeners() {
                this._config.keyboard && H.on(this._element, e8, e => this._keydown(e)),
                    "hover" === this._config.pause && (H.on(this._element, e$, () => this.pause()),
                        H.on(this._element, eb, () => this._maybeEnableCycle())),
                    this._config.touch && eu.isSupported() && this._addTouchEventListeners()
            }
            _addTouchEventListeners() {
                for (let e of et.find(".carousel-item img", this._element))
                    H.on(e, ew, e => e.preventDefault());
                let t = () => {
        ...
        class eR extends X {
            ...
            show() {
                ...
                let s = () => {
                    this._isTransitioning = !1,
                        ...
                        this._element.classList.add(eM, eH),
            ...
            hide() {
                ...
                for (let i of (this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`,
                    f(this._element),
                    this._element.classList.add(eq),
                    this._element.classList.remove(eM, eH),
                    this._triggerArray)) {
                    let n = r(i);
        ...
        let th = {
            ...
            fn: function e(t) {
                ...
                Object.keys(i.elements).forEach(function (e) {
                    var t = i.styles[e] || {}
                        , n = i.attributes[e] || {}
                        , s = i.elements[e];
                    tc(s) && to(s) && (Object.assign(s.style, t),
            ...
            effect: function e(t) {
                ...
                return Object.assign(i.elements.popper.style, n.popper),
                    i.styles = n,
                    ...
                    function () {
                        Object.keys(i.elements).forEach(function (e) {
                            ...
                            tc(t) && to(t) && (Object.assign(t.style, r),
        ...
        function ty(e, t, i) {
            ...
            var n = e.getBoundingClientRect()
                , s = 1
                , r = 1;
            t && tc(e) && (s = e.offsetWidth > 0 && tg(n.width) / e.offsetWidth || 1,
                r = e.offsetHeight > 0 && tg(n.height) / e.offsetHeight || 1);
        ...
        function tT(e) {
            for (var t = ta(e), i = t_(e); i && tw(i) && "static" === tb(i).position;)
                i = t_(i);
            return i && ("html" === to(i) || "body" === to(i) && "static" === tb(i).position) ? t : i || function e(t) {
                var i = /firefox/i.test(tm());
                if (/Trident/i.test(tm()) && tc(t) && "fixed" === tb(t).position)
                    return null;
                var n = tC(t);
                for (tu(n) && (n = n.host); tc(n) && 0 > ["html", "body"].indexOf(to(n));) {
                    var s = tb(n);
                    if ("none" !== s.transform || "none" !== s.perspective || "paint" === s.contain || -1 !== ["transform", "perspective"].indexOf(s.willChange) || i && "filter" === s.willChange || i && s.filter && "none" !== s.filter)
                        return n;
                    n = n.parentNode
                }
                return null
        ...
        let tL = {
            ...
            phase: "main",
            fn: function e(t) {
                var i, n = t.state, s = t.name, r = t.options, o = n.elements.arrow, a = n.modifiersData.popperOffsets, l = td(n.placement), c = tE(l), u = [eX, eV].indexOf(l) >= 0 ? "height" : "width";
                if (o && a) {
                    var h, d, p = (h = r.padding,
                        d = n,
                        tS("number" != typeof (h = "function" == typeof h ? h(Object.assign({}, d.rects, {
                            placement: d.placement
                        })) : h) ? h : tD(h, eK))), f = t8(o), g = n.rects.reference[u] + n.rects.reference[c] - a[c] - n.rects.popper[u], m = a[c] - n.rects.reference[c], v = tT(o), y = v ? "y" === c ? v.clientHeight || 0 : v.clientWidth || 0 : 0, $ = p["y" === c ? "top" : eX], b = y - f[u] - p["y" === c ? e1 : eV], w = y / 2 - f[u] / 2 + (g / 2 - m / 2), x = tk($, w, b), C = c;
                    n.modifiersData[s] = ((i = {})[C] = x,
                        i.centerOffset = x - w,
                        i)
                }
            },
        ...
        function tO(e) {
            var t, i, n = e.popper, s = e.popperRect, r = e.placement, o = e.variation, a = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, h = e.roundOffsets, d = e.isFixed, p = a.x, f = void 0 === p ? 0 : p, g = a.y, m = void 0 === g ? 0 : g, v = "function" == typeof h ? h({
                x: f,
                y: m
            }) : {
                x: f,
            ...
            if (u) {
                var C = tT(n)
                    ...
                    , T = "clientWidth";
                C === ta(n) && (C = tx(n),
                    "static" !== tb(C).position && "absolute" === l && (_ = "scrollHeight",
                        T = "scrollWidth")),
                    ("top" === r || (r === eX || r === eV) && "end" === o) && (w = e1,
                        m -= (d && C === x && x.visualViewport ? x.visualViewport.height : C[_]) - s.height,
                        m *= c ? 1 : -1),
                    (r === eX || ("top" === r || r === e1) && "end" === o) && (b = eV,
                        f -= (d && C === x && x.visualViewport ? x.visualViewport.width : C[T]) - s.width,
                        f *= c ? 1 : -1)
            }
            ...
            return (f = L.x,
                m = L.y,
                c) ? Object.assign({}, D, ((i = {})[w] = $ ? "0" : "",
                    i[b] = y ? "0" : "",
                    i.transform = 1 >= (x.devicePixelRatio || 1) ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)",
                    i)) : Object.assign({}, D, ((t = {})[w] = $ ? m + "px" : "",
                        t[b] = y ? f + "px" : "",
                        t.transform = "",
                        t))
        }
        ...
        function tF(e, t) {
            ...
            }(e), s = n === (null == (i = e.ownerDocument) ? void 0 : i.body), r = ta(n), o = s ? [r].concat(r.visualViewport || [], t0(n) ? n : []) : n, a = t.concat(o);
        ...
        function tV(e) {
            var t, i = e.reference, n = e.element, s = e.placement, r = s ? td(s) : null, o = s ? t9(s) : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
            switch (r) {
                case "top":
                    t = {
                        x: a,
        ...
        function tX(e, t) {
            void 0 === t && (t = {});
            var i, n, s, r, o, a, l, c, u, h, d = t, p = d.placement, f = void 0 === p ? e.placement : p, g = d.strategy, m = void 0 === g ? e.strategy : g, v = d.boundary, y = d.rootBoundary, $ = d.elementContext, b = void 0 === $ ? e2 : $, w = d.altBoundary, x = d.padding, C = void 0 === x ? 0 : x, _ = tS("number" != typeof C ? C : tD(C, eK)), T = e.rects.popper, E = e.elements[void 0 !== w && w ? b === e2 ? e4 : e2 : b], k = (i = tl(E) ? E : E.contextElement || tx(e.elements.popper),
                n = void 0 === v ? eQ : v,
                s = void 0 === y ? eY : y,
                r = m,
                u = (c = [].concat("clippingParents" === n ? (o = i,
                    a = tF(tC(o)),
                    l = ["absolute", "fixed"].indexOf(tb(o).position) >= 0 && tc(o) ? tT(o) : o,
                    tl(l) ? a.filter(function (e) {
                        return tl(e) && t$(e, l) && "body" !== to(e)
                    }) : []) : [].concat(n), [s]))[0],
                (h = c.reduce(function (e, t) {
                    var n = t1(i, t, r);
                    return e.top = tp(n.top, e.top),
                        e.right = tf(n.right, e.right),
                        e.bottom = tf(n.bottom, e.bottom),
                        e.left = tp(n.left, e.left),
                        e
                }, t1(i, u, r))).width = h.right - h.left,
                h.height = h.bottom - h.top,
                h.x = h.left,
                h.y = h.top,
                h), A = ty(e.elements.reference), S = tV({
                    reference: A,
                    element: T,
                    strategy: "absolute",
                    placement: f
                }), D = tR(Object.assign({}, T, S)), L = b === e2 ? D : A, N = {
                ...
                if (!i.modifiersData[s]._skip) {
                    for (var r = n.mainAxis, o = void 0 === r || r, a = n.altAxis, l = void 0 === a || a, c = n.fallbackPlacements, u = n.padding, h = n.boundary, d = n.rootBoundary, p = n.altBoundary, f = n.flipVariations, g = void 0 === f || f, m = n.allowedAutoPlacements, v = i.options.placement, y = td(v), $ = [v].concat(c || (y !== v && g ? function e(t) {
                        ...
                        return e.concat(td(t) === eU ? (n = i,
                            ...
                            0 === (b = ($ = (y = t9(o)) ? p ? e7 : e7.filter(function (e) {
                                return t9(e) === y
                            }) : eK).filter(function (e) {
                                return v.indexOf(e) >= 0
                            })).length && (b = $),
                            Object.keys(w = b.reduce(function (e, t) {
                                return e[t] = tX(n, {
                                    placement: t,
                                    boundary: a,
                                    rootBoundary: l,
                    ...
                    if (C)
                        for (var I = g ? 3 : 1, j = function e(t) {
                            ...
                            ;
                    i.placement !== _ && (i.modifiersData[s]._skip = !0,
                        i.placement = _,
                        i.reset = !0)
                }
            },
        ...
        let tQ = {
                    ...
                    var i = t.state
                        ...
                        , a = eZ.reduce(function (e, t) {
                            ...
                            return e[t] = (n = t,
                                ...
                                u = (c = "function" == typeof r ? r(Object.assign({}, s, {
                                    placement: n
                                })) : r)[0],
                                h = c[1],
                                u = u || 0,
                        ...
                        , c = l.x
                        , u = l.y;
                    null != i.modifiersData.popperOffsets && (i.modifiersData.popperOffsets.x += c,
            ...
            , t4 = {
                ...
                phase: "main",
                fn: function e(t) {
                    var i, n = t.state, s = t.options, r = t.name, o = s.mainAxis, a = s.altAxis, l = s.boundary, c = s.rootBoundary, u = s.altBoundary, h = s.padding, d = s.tether, p = void 0 === d || d, f = s.tetherOffset, g = void 0 === f ? 0 : f, m = tX(n, {
                        boundary: l,
                        rootBoundary: c,
                        padding: h,
                        altBoundary: u
                    }), v = td(n.placement), y = t9(n.placement), $ = !y, b = tE(v), w = "x" === (i = b) ? "y" : "x", x = n.modifiersData.popperOffsets, C = n.rects.reference, _ = n.rects.popper, T = "function" == typeof g ? g(Object.assign({}, n.rects, {
                        ...
                        mainAxis: 0,
                        altAxis: 0
                    }, T), k = n.modifiersData.offset ? n.modifiersData.offset[n.placement] : null, A = {
                        x: 0,
                        y: 0
                    };
                    if (x) {
                        if (void 0 === o || o) {
                            var S, D = "y" === b ? "top" : eX, L = "y" === b ? e1 : eV, N = "y" === b ? "height" : "width", O = x[b], P = O + m[D], I = O - m[L], j = p ? -_[N] / 2 : 0, z = y === e3 ? C[N] : _[N], H = y === e3 ? -_[N] : -C[N], M = n.elements.arrow, q = p && M ? t8(M) : {
                                width: 0,
                                height: 0
                            }, W = n.modifiersData["arrow#persistent"] ? n.modifiersData["arrow#persistent"].padding : tA(), B = W[D], F = W[L], R = tk(0, C[N], q[N]), V = $ ? C[N] / 2 - j - R - B - E.mainAxis : z - R - B - E.mainAxis, X = $ ? -C[N] / 2 + j + R + F + E.mainAxis : H + R + F + E.mainAxis, U = n.elements.arrow && tT(n.elements.arrow), K = U ? "y" === b ? U.clientTop || 0 : U.clientLeft || 0 : 0, Q = null != (S = null == k ? void 0 : k[b]) ? S : 0, Y = tk(p ? tf(P, O + V - Q - K) : P, O, p ? tp(I, O + X - Q) : I);
                            x[b] = Y,
                                A[b] = Y - O
                        }
                        if (void 0 !== a && a) {
                            var Z, G, J, ee, et, ei = x[w], en = "y" === w ? "height" : "width", es = ei + m["x" === b ? "top" : eX], er = ei - m["x" === b ? e1 : eV], eo = -1 !== ["top", eX].indexOf(v), ea = null != (Z = null == k ? void 0 : k[w]) ? Z : 0, el = eo ? es : ei - C[en] - _[en] - ea + E.altAxis, ec = eo ? ei + C[en] + _[en] - ea - E.altAxis : er, eu = p && eo ? (G = el,
                                J = ei,
                                ee = ec,
                                (et = tk(G, J, ee)) > ee ? ee : et) : tk(p ? el : es, ei, p ? ec : er);
                            x[w] = eu,
                                A[w] = eu - ei
                        }
                        n.modifiersData[r] = A
            ...
            return function e(t, i, s) {
                ...
                var o, a, l = {
                    ...
                    forceUpdate: function e() {
                        if (!u) {
                            var t, i, n, s, r, o, a, c, d, p, f, g, m, v, y, $ = l.elements, b = $.reference, w = $.popper;
                            if (tZ(b, w)) {
                                l.rects = {
                                    reference: (n = b,
                                        s = tT(w),
                                        ...
                                        o = tc(s),
                                        f = tc(s) && (d = tg((c = (a = s).getBoundingClientRect()).width) / a.offsetWidth || 1,
                                            p = tg(c.height) / a.offsetHeight || 1,
                                            1 !== d || 1 !== p),
                                        g = tx(s),
                                        m = ty(n, f, r),
                                        v = {
        ...
        var t5 = tG()
            , t6 = tG({
                defaultModifiers: [tj, t2, tP, th]
            })
            , tJ = tG({
                defaultModifiers: [tj, t2, tP, th, tY, tU, t4, tL, tQ]
            });
        ...
        class iT extends X {
            ...
            static clearMenus(e) {
                ...
                for (let i of t) {
                    ...
                    if (s.includes(n._element) || "inside" === n._config.autoClose && !r || "outside" === n._config.autoClose && r || n._menu.contains(e.target) && ("keyup" === e.type && "Tab" === e.key || /input|select|option|textarea|form/i.test(e.target.tagName)))
                        continue;
                    let o = {
        ...
        H.on(document, ih, ig, iT.dataApiKeydownHandler),
            ...
            H.on(document, iu, ig, function (e) {
                e.preventDefault(),
                    iT.getOrCreateInstance(this).toggle()
            }),
            $(iT);
        ...
        class iD {
            ...
            hide() {
                ...
                this._disableOverFlow(),
                    this._setElementAttributes(this._element, iA, t => t + e),
                    this._setElementAttributes(iE, iA, t => t + e),
                    this._setElementAttributes(ik, iS, t => t - e)
            }
            reset() {
            ...
            _applyManipulationCallback(e, t) {
                ...
                for (let i of et.find(e, this._element))
                    t(i)
            }
        }
        let iL = "backdrop"
        ...
        class iI extends V {
            ...
            dispose() {
                this._isAppended && (H.off(this._element, iN),
                    this._element.remove(),
                    this._isAppended = !1)
            }
            _getElement() {
        ...
        class iB extends V {
            ...
            activate() {
                !this._isActive && (this._config.autofocus && this._config.trapElement.focus(),
                    H.off(document, ij),
                    H.on(document, iz, e => this._handleFocusin(e)),
                    H.on(document, iH, e => this._handleKeydown(e)),
                    this._isActive = !0)
            }
            deactivate() {
        ...
        class i5 extends X {
            ...
            _triggerBackdropTransition() {
                ...
                !("hidden" === i || this._element.classList.contains(i7)) && (t || (this._element.style.overflowY = "hidden"),
        ...
        class ng extends X {
            ...
            hide() {
                ...
                this._focustrap.deactivate(),
                    ...
                    this._backdrop.hide();
                let t = () => {
                    this._element.classList.remove(nt, nn),
                        this._element.removeAttribute("aria-modal"),
                        this._element.removeAttribute("role"),
                        this._config.scroll || new iD().reset(),
        ...
        H.on(document, nh, '[data-bs-toggle="offcanvas"]', function (e) {
            ...
            H.on(window, ne, () => {
                for (let e of et.find(ns))
                    ng.getOrCreateInstance(e).show()
            }
            ),
            H.on(window, nu, () => {
                for (let e of et.find("[aria-modal][class*=show][class*=offcanvas-]"))
                    "fixed" !== getComputedStyle(e).position && ng.getOrCreateInstance(e).hide()
            }
            ),
            U(ng),
            $(ng);
        ...
        class nO extends X {
            ...
            show() {
                ...
                if (this._element.ownerDocument.documentElement.contains(this.tip) || (s.append(n),
            ...
            _getTemplateFactory(e) {
                return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new nC({
                    ...this._config,
                    content: e,
                ...
                for (let t of e)
                    if ("click" === t)
                        ...
                        H.on(this._element, i, this._config.selector, e => {
                            let t = this._initializeOnDelegatedTarget(e);
                            t._activeTrigger["focusin" === e.type ? nD : nS] = !0,
                                t._enter()
                        }
                        ),
                            H.on(this._element, n, this._config.selector, e => {
                                let t = this._initializeOnDelegatedTarget(e);
                                t._activeTrigger["focusout" === e.type ? nD : nS] = t._element.contains(e.relatedTarget),
                                    t._leave()
                            }
                            )
                    }
        ...
        class nV extends X {
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll && (H.off(this._config.target, nM),
            ...
            _initializeTargetsAndObservables() {
                ...
                for (let t of e) {
                    ...
                    u(i) && (this._targetLinks.set(t.hash, t),
        ...
        H.on(window, nq, () => {
            for (let e of et.find('[data-bs-spy="scroll"]'))
                nV.getOrCreateInstance(e)
        }
        ),
            $(nV);
        let nX = ".bs.tab"
        ...
        class ss extends X {
            constructor(e) {
                ...
                this._setInitialAttributes(this._parent, this._getChildren()),
                    H.on(this._element, n2, e => this._keydown(e))
            }
            static get NAME() {
                return "tab"
            }
            ...
            _keydown(e) {
                if (!["ArrowLeft", n7, "ArrowUp", nZ].includes(e.key))
                    return;
                e.stopPropagation(),
                    e.preventDefault();
    ...
    function (e) {
        ...
        var t, i, n, s, r, o, a = "Close", l = "BeforeClose", c = "MarkupParse", u = "Open", h = "Change", d = ".mfp", p = "mfp-ready", f = "mfp-removing", g = "mfp-prevent-close", m = function () { }, v = !!window.jQuery, y = e(window), $ = function (e, i) {
            t.ev.on("mfp" + e + d, i)
        }, b = function (t, i, n, s) {
            ...
            e.magnificPopup.instance || ((t = new m).init(),
        ...
        m.prototype = {
            ...
            open: function (i) {
                ...
                t.types = [],
                    ...
                    t.bgOverlay || (t.bgOverlay = b("bg").on("click" + d, function () {
                        t.close()
                    }),
                ...
                w("BeforeOpen"),
                    t.st.showCloseBtn && (t.st.closeBtnInside ? ($(c, function (e, t, i, n) {
            ...
            close: function () {
                t.isOpen && (w(l),
                    t.isOpen = !1,
                    t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(f),
                        setTimeout(function () {
                            t._close()
            ...
            _checkIfClose: function (i) {
                if (!e(i).hasClass(g)) {
                    ...
                    if (n && s || !t.content || e(i).hasClass("mfp-close") || t.preloader && i === t.preloader[0])
                        return !0;
                ...
                getInline: function (i, n) {
                    if (S(),
                        ...
                        if (r.length) {
                            ...
                            o && o.tagName && (E || (E = b(T = s.hiddenClass),
                                T = "mfp-" + T),
                    ...
                    var s = 0
                        , r = function () {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"),
                                ...
                                i.hasSize = !0,
                                i.loaded = !0,
                                w("ImageLoadComplete")) : ++s < 200 ? setTimeout(r, 100) : o())
                        }
                        , o = function () {
                ...
                proto: {
                    initZoom: function () {
                        ...
                        if (i.enabled && t.supportsTransition) {
                            var s, r, o = i.duration, c = function (e) {
                    ...
                    _getOffset: function (i) {
                        ...
                        return (void 0 === I && (I = void 0 !== document.createElement("p").style.MozTransform),
                            I) ? a["-moz-transform"] = a.transform = "translate(" + s.left + "px," + s.top + "px)" : (a.left = s.left,
                                a.top = s.top),
                            a
                    }
                }
                ...
                getIframe: function (i, n) {
                    ...
                    e.each(r.patterns, function () {
                        if (s.indexOf(this.index) > -1)
                            return this.id && (s = "string" == typeof this.id ? s.substr(s.lastIndexOf(this.id) + this.id.length, s.length) : this.id.call(this, s)),
    ...
    function (e) {
        ...
        r.prototype = {
            init: function (t) {
                this.update(t, s) && (this.element.addClass(this.options.className),
                    this.options.innerToggle && (this.wrapElement(this.options.wrapper),
                        ...
                        "string" == typeof this.options.innerToggle && (this.toggleElement.hide(),
                            this.element.one(this.options.innerToggle, e.proxy(function () {
            ...
            updateElement: function () {
                return !(!this.options.enable || this.isType()) && (this.element.prop(e.extend({}, this.options.props, this.state().props)).addClass(this.state().className).removeClass(this.otherState().className),
                    this.options.triggerOnToggle && this.element.trigger(this.options.triggerOnToggle, [this]),
                    this.updateToggle(),
                    !0)
            },
            isType: function (e, i) {
                return (i = i || this.options.states)[e = e || this.state(t, t, i).props.type] && (e = i[e].props.type),
            ...
            wrapElement: function (t) {
                ...
                return this.wrapperElement.length || (i = this.element.outerWidth(),
                    e.each(t.inheritStyles, e.proxy(function (e, i) {
            ...
            initToggle: function (t) {
                return !this.toggleElement.length && (this.toggleElement = e(t.element).attr(t.attr).addClass(t.className).css(t.styles).appendTo(this.wrapperElement),
                    this.updateToggle(),
                    this.positionToggle(t.position, t.verticalAlign, t.offset),
                    t.touchSupport ? (this.toggleElement.css(t.touchStyles),
                        this.element.on(t.attachToTouchEvent, e.proxy(this.toggleTouchEvent, this))) : this.toggleElement.on(t.attachToEvent, e.proxy(this.toggleEvent, this)),
            ...
            toggleKeyEvent: function (t) {
                e.each(this.options.toggle.attachToKeyCodes, e.proxy(function (e, i) {
                    if (t.which === i)
                        return this.toggleEvent(t),
                            !1
                }, this))
            },
            toggleTouchEvent: function (e) {
                var t, i, n, s = this.toggleElement.offset().left;
                s && (t = e.pageX || e.originalEvent.pageX,
                    "left" === this.options.toggle.position ? (s += this.toggleElement.outerWidth(),
                        i = t,
                        n = s) : (i = s,
                            n = t),
